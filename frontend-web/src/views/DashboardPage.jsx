  ...
  return (
    <div>
      ...
      <Container className="mt-4">
            ...
            <Card className="shadow-sm rounded-4">
              <Card.Body className="text-center">
                ...
                <Card.Text className="mb-3">
                  Estado actual: <strong className={plumaEntrada === "abierta" ? "text-success" : "text-danger"}>{plumaEntrada.toUpperCase()}</strong>
                </Card.Text>
                <Button
          ...
          <Col md={5} className="mb-3">
            <Card className="shadow-sm rounded-4">
              <Card.Body className="text-center">
                ...
                <Card.Text className="mb-3">
                  Estado actual: <strong className={plumaSalida === "abierta" ? "text-success" : "text-danger"}>{plumaSalida.toUpperCase()}</strong>
                </Card.Text>
                <Button
        ...
        {/* Gráfico debajo de las tarjetas */}
        <Row className="mt-4">
          <Col>
            <Card className="shadow-sm rounded-4">
              <Card.Body>
                ...
                {!cargando && (
                  <div className="mt-3 resumen-cajones text-center">
                    <span className="me-3"><strong>Libres:</strong> {libres}</span>
                    <span className="me-3"><strong>Ocupados:</strong> {ocupados}</span>
